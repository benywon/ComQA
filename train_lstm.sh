...
model_save_path=${base_dir}/model/lstm.comqa.th
echo $jobname
...
echo "start training"
python3.6 -m torch.distributed.launch --nproc_per_node=4 lstm.py \
...
python3 evaluate_lstm.py ${test_features_path} ${model_save_path}